...
class TensorParallelMLP(nn.Module):  # 继承 nn.Module，注册为可训练模块
    """
    Tensor Parallel MLP module.
    """
    def __init__(self, d_model, d_ff, world_size):  # 初始化: 定义模型结构和参数
